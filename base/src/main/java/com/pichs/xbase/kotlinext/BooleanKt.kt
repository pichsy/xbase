...
inline fun String?.isNotNULLOrEmpty(block: (String) -> Unit): String? {
...
inline fun String?.isNULLOrEmpty(block: () -> Unit): String? {
    if (this.isNullOrEmpty()) {
        block()
    }
    return this
...
inline fun <E> Collection<E>.isListNotEmpty(block: (Collection<E>) -> Unit): Collection<E> {
    if (this.isNotEmpty()) {
        block(this)
    }
    return this
...
inline fun <E> Collection<E>?.isNotNULLOrEmpty(block: (Collection<E>) -> Unit): Collection<E>? {
    if (!this.isNullOrEmpty()) {
        block(this)
    }
    return this
...
inline fun <E> Collection<E>?.isNULLOrEmpty(block: () -> Unit): Collection<E>? {
    if (this.isNullOrEmpty()) {
        block()
    }
    return this
